...
def main():
    ...
    # graph.add_edge(node_1, node_2, 5, 0.0)
    # graph.add_edge(node_1, node_3, 1, 0.0)
    # graph.add_edge(node_2, node_3, 3, 0.0)
    # graph.add_edge(node_2, node_4, 2, 0.0)
    # graph.add_edge(node_2, node_5, 8, 0.0)
    # graph.add_edge(node_3, node_5, 1, 0.0)
    # graph.add_edge(node_3, node_7, 4, 0.0)
    # graph.add_edge(node_4, node_6, 1, 0.0)
    # graph.add_edge(node_4, node_8, 4, 0.0)
    # graph.add_edge(node_5, node_7, 2, 0.0)
    # graph.add_edge(node_6, node_7, 4, 0.0)
    # graph.add_edge(node_6, node_8, 7, 0.0)
    # graph.add_edge(node_7, node_9, 3, 0.0)
    # graph.add_edge(node_7, node_10, 5, 0.0)
    # graph.add_edge(node_8, node_10, 2, 0.0)
    # graph.add_edge(node_9, node_10, 1, 0.0)
